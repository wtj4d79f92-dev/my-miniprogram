...
const SEEDS = [
  ...
  { city: '北京', type: 'climbing', title: '慕田峪长城景区徒步', location: '北京市怀柔区 慕田峪长城景区', difficulty: 4, distance: 8, climb: 600, fee: 0, max: 10, tags: ['needPassenger'], day: 6, hour: 6, joined: 8 },
  ...
  { city: '北京', type: 'camping', title: '玉渡山露营看日出 · 自带装备', location: '北京市延庆区 玉渡山风景区', difficulty: 0, distance: 0, climb: 0, fee: 120, max: 8, tags: [], day: 3, hour: 15, joined: 4 },
  ...
  { city: '深圳', type: 'hiking', title: '梧桐山登顶（需体力）', location: '广东省深圳市 梧桐山北门', difficulty: 5, distance: 12, climb: 700, fee: 0, max: 12, tags: ['needOwner'], day: 7, hour: 7, joined: 10 },
  ...
  { city: '成都', type: 'climbing', title: '青城后山徒步 · 溪谷清凉', location: '四川省成都市 青城后山泰安古镇', difficulty: 4, distance: 10, climb: 600, fee: 0, max: 10, tags: ['needPassenger'], day: 5, hour: 5, joined: 8 },
  ...
  { city: '厦门', type: 'camping', title: '五缘湾湿地公园野餐 · 天幕已备', location: '福建省厦门市 五缘湾湿地公园', difficulty: 0, distance: 0, climb: 0, fee: 100, max: 8, tags: [], day: 6, hour: 15, joined: 5 },
]
